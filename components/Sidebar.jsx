...
const Sidebar = ({onPost}) => {
  ...
  return (
    ...
    <div className={`${darkMode ? 'bg-dark-mode text-white': 'bg-white'} z-50 flex flex-row justify-around phone:justify-normal w-full phone:w-min fixed bottom-0 phone:flex-col xl:w-64 h-min phone:h-[100dvh] gap-3 xl:pr-10 phone:p-3 phone:pt-0 p-2 phone:relative`}>
