...
const Compose = ({setForm, onPost}) => {
  ...
  return (
    <section className='flex items-start backdrop-brightness-50 justify-center min-h-responsive z-50 absolute left-0 right-0'>
      <main className={`${darkMode ? 'bg-black text-white card-light': 'bg-white card'} relative flex flex-col mt-10 w-full min-h-responsive tablet:w-[600px] tablet:min-h-min tablet:rounded-2xl`}>
